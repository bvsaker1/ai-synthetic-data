...
def build_common_user_prompt(
	...
	return (
		...
		"- If tools_required lists specific tools, explicitly reference them in the answer or steps so the tool list is visibly used.\n"
		...
		"- Do not leave the user with only symptoms or only a tool list; every answer should close the loop.\n"
