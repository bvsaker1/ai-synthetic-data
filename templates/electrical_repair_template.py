...
ELECTRICAL_SPECIFIC_PROMPT_INFO = (
	...
	"- Tips must be related and relevant to the repair and be NON-OBVIOUS electrical insights, NOT safety reminders. Examples of GOOD tips:\n"
	...
	"  * A tip about GFCI is unrelated to fixing a loose outlet."
